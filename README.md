...
// 振り返りを保存する
addReflection('xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx', {
  outcome: '決算後に上昇したが、自分は途中で売却した',
  learning: '買う前に、どこまで持つかを先に決めておく',
});
```
...
| `reflection`| object \| null | 振り返り内容 `{ outcome, learning, reviewedAt }` |